---
name: ask-hr
description: Review content for offensive language, cultural insensitivity, identity bias, and cancel risk before it goes public. Use when the user wants HR-level screening of emails, social posts, blog content, scripts, or any text going to a broad audience.
---
