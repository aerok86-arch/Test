---
name: content
description: Turn any content the user shares into 3-4 finished LinkedIn posts, ready to publish. Use when the user shares a URL, PDF, email, newsletter, notes, or any source material and wants it repurposed as LinkedIn posts.
---
